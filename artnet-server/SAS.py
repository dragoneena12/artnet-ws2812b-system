...
class StupidArtnetServer:
    ...
    def __init_socket(self):
        ...
        self.socket_server.setsockopt(socket.SOL_SOCKET, socket.SO_RCVBUF, 0)
    ...
    def register_listener(
        self, universe=0, sub=0, net=0, is_simplified=True, callback_function=None
    ):
    ...
    def delete_listener(self, listener_id):
        ...
        None
        """
        self.listeners = [i for i in self.listeners if not i["id"] == listener_id]
    ...
    def set_address_filter(
        self, listener_id, universe, sub=0, net=0, is_simplified=True
    ):
